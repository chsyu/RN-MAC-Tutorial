var imageOps = {
  ...
  impure: {
    ...
    createInlinedContainer: function(imgA, imgB) {
      var bodyWidth = document.DO_PAGEWIDTH || document.querySelector('body').getBoundingClientRect().width
...
function wrapPrintHeaders() {
  ...
  nodes.each(function(_, node) {
    ...
    var breakerTag = "<div class='break-breaker' style='page-break-inside: avoid'/>"
    $(node).next()
    .andSelf()
    .wrapAll(breakerTag)
  })
